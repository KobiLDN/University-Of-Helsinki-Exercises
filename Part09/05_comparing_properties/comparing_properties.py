...
class RealProperty:
    ...
    def price_difference(self, compared_to):
        priceProperty1 = self.square_metres * self.price_per_sqm
        priceProperty2 = compared_to.square_metres * compared_to.price_per_sqm
        if priceProperty1 > priceProperty2:
            return priceProperty1 - priceProperty2
        else:
            return priceProperty2 - priceProperty1

    def more_expensive(self, compared_to):
        priceProperty1 = self.square_metres * self.price_per_sqm
        priceProperty2 = compared_to.square_metres * compared_to.price_per_sqm
        result = priceProperty1 - priceProperty2
        return result > 0
